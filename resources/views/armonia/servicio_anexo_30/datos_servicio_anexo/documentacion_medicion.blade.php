    ...
    <section class="section">
        <div class="section-header">
            <h3 class="page__heading">
                {{ $servicio->nomenclatura }}-LISTA DE DOCUMENTOS REQUERIDOS SITEMAS DE MEDICION ANEXO 30 y 31 RMF 2024
                                                                        ...
                                                                        <div class="modal-dialog modal-lg" role="document">
                                                                            <div class="modal-content">
                                                                                ...
                                                                                <div class="modal-body">
                                                                                    <form action="{{ route('documentacion_anexo_medicion.store') }}" method="POST"
