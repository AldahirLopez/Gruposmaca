...
<section class="section">
    <div class="section-header">
        <h3 class="page__heading">REQUSISITOS PARA LA APROBACIÓN DEL SISTEMA INFORMATICO ANEXOS 30 Y 31
                                    ...
                                    <div class="modal-dialog modal-lg" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form action="{{ route('documentacion_anexo_informatico.store') }}" method="POST"
