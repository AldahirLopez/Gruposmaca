                        ...
                        <div class="card-body">
                            ...
                            <div style="margin-top: 15px;">
                                ...
                                @if($estaciones->isNotEmpty())
                                    ...
                                    @endcan
                                @else
                                    <a href="{{ route('estacion.selecccion') }}" class="btn btn-primary">
                                        Registre su primera estación
                                    </a>
                                @endif
                            </div>
                            ...
                            @if(auth()->check() && auth()->user()->hasAnyRole('Administrador', 'Auditor'))
                                <form action="{{ route('servicio_inspector_anexo_30.obtenerServicios') }}" method="GET"
                                ...
                                <div id="tablaServicios">
                                    <table class="table table-striped">
                                        ...
                                        <tbody style="text-align: center;">
                                                        ...
                                                        <div class="modal-dialog modal-lg" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <form action="{{ route('pago_anexo.store') }}" method="POST"
                                            ...
                                            @empty
                                                <tr>
                                                    <td colspan="8">No se encontraron servicios para mostrar.</td>
                                                </tr>
