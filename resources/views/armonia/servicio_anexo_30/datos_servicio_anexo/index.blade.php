...
<section class="section">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div style="margin-top: 15px;">
                            ...
                            <button type="button" class="btn btn-success" data-toggle="modal" data-target="#generarServicioModal">
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody style="text-align: center;">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('descargar.factura.anexo') }}?rutaDocumento={{ urlencode($servicio->pago->factura->ruta_pdf) }}" class="btn btn-primary btn-descargar-factura" data-carpeta="{{ $servicio->nomenclatura }}">
                                        ...
                                        <td scope="row">
                                            ...
                                            @if ($servicio->pago !== null)
                                            <button type="button" class="btn btn-success" data-toggle="modal" data-target="#agregarDocumentoModal-{{$servicio->nomenclatura }}" disabled>
                                                <i class="bi bi-upload"></i> Agregar
                                            </button>

                                            @else
                                            <button type="button" class="btn btn-success" data-toggle="modal" data-target="#agregarDocumentoModal-{{$servicio->nomenclatura }}">
                                                <i class="bi bi-upload"></i> Agregar
                                            </button>
                                        ...
                                        <td scope="row">
                                            ...
                                            @else
                                            <a href="{{ route('descargar.cotizacion.ajax') }}?rutaDocumento={{ urlencode($servicio->cotizacion->rutadoc_cotizacion) }}" class="btn btn-primary btn-descargar-pdf" data-carpeta="{{ $servicio->nomenclatura }}">
                                                <i class="bi bi-file-earmark-check-fill"></i>
                                            </a>
                                            @endif
                                        </td>
                                    ...
                                    <div class="modal fade" id="agregarDocumentoModal-{{$servicio->nomenclatura }}" tabindex="-1" role="dialog" aria-labelledby="agregarDocumentoLabel-{{$servicio->nomenclatura }}" aria-hidden="true">
                                        <div class="modal-dialog modal-lg" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header" style="background-color: #007bff; color: #ffffff;">
                                                    <h5 class="modal-title" id="agregarDocumentoLabel-{{ $servicio->nomenclatura }}">
                                                        Agregar Pago:{{$servicio->nomenclatura}}</h5>
                                                    <button type="button" class="btn-close btn-close-white" data-dismiss="modal" aria-label="Close"></button>
                                                </div>
                                                <div class="modal-body">
                                                    <form action="{{ route('pago_anexo.store') }}" method="POST" enctype="multipart/form-data">
                                                        @csrf
    ...
    <div class="modal fade" id="generarServicioModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form id="generateWordForm" action="{{ route('servicio_inspector_anexo_30.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
