                                ...
                                <tbody style="text-align: center;">
                                    ...
                                    <tr>
                                        ...
                                        <td scope="row">
                                            ...
                                            @else
                                            <a href="{{ $servicio->cotizacion ? $servicio->cotizacion->ruta_doc_url : '#' }}" target="_blank" class="btn btn-primary btn-generar-pdf">
                                        ...
                                        <td scope="row">
                                            ...
                                            @else
                                            <a href="{{ route('archivos_anexo.index', ['servicio_anexo_id' => $servicio->id]) }}" class="btn btn-primary">
                                        ...
                                        <td scope="row">
                                            ...
                                            <a href="{{ route('archivos.index', ['servicio_id' => $servicio->id]) }}" class="btn btn-primary btn-generar-pdf">
                                                <i class="bi bi-file-earmark-check-fill"></i>
                                            </a>
                                            @endif
                                            @can('borrar-servicio')
