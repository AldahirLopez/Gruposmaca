...
<section class="section">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-primary" data-toggle="modal"
                                                data-target="#agregarDocumentoModal-{{ $estacion->id }}"><i
                                                    class="bi bi-file-earmark-plus"></i></button>
                                        </td>
                                        <td>
                                            <button type="button" class="btn btn-primary" data-toggle="modal"
                                                data-target="#editarEstacionModal-{{ $estacion->id }}"><i
    ...
    @foreach($estaciones as $estacion)
        ...
        <div class="modal fade" id="agregarDocumentoModal-{{ $estacion->id }}" tabindex="-1" role="dialog"
            aria-labelledby="agregarDocumentoLabel-{{ $estacion->id }}" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header" style="background-color: #007bff; color: #ffffff;">
                        <h5 class="modal-title" id="agregarDocumentoLabel-{{ $estacion->id }}">Agregar Documento</h5>
                        <button type="button" class="btn-close btn-close-white" data-dismiss="modal"
                            aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
