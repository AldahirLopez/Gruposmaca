                            ...
                            <tbody style="text-align: center;">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @else
                                        <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#subirSustentoModal{{ $dictamen->id }}">
                                            Subir Sustento
                                        </button>
                                        @endif
                                    </td>
                ...
                <form id="generateWordForm" action="{{ route('construccion.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row" style="padding-top: 10px;">
                        <div class="form-group col-md-6">
                            ...
                            <select name="usuario_operacion_mantenimiento" class="form-select" id="usuario_operacion_mantenimiento">
...
@foreach ($dictamenes as $dictamen)
<div class="modal fade" id="subirSustentoModal{{ $dictamen->id }}" tabindex="-1" role="dialog" aria-labelledby="subirSustentoModalLabel{{ $dictamen->id }}" aria-hidden="true">
