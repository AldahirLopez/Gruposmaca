...
return new class extends Migration {
    ...
    public function up(): void
    {
        Schema::connection('segunda_db')->create('estacion_servicio_operacion_mantenimiento', function (Blueprint $table) {
            ...
            $table->foreign('servicio_operacion_id')->references('id')->on('armonia.operacion_mantenimiento')->onDelete('cascade');
        });
    }
    ...
    {
        Schema::dropIfExists('estacion_servicio_operacion_mantenimiento');
    }
};
